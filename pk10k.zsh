# Generated by Powerlevel10k configuration wizard on 2021-10-07 at 17:53 BST.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_DIRENV_VISUAL_IDENTIFIER_EXPANSION='venv'
  ...
  # typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|aws-vault|awless|terraform|pulumi'
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      '*assertis_Admin*'  ASSERTIS_ADMIN    # to match your needs. Customize them as needed.
      '*assertis*'  ASSERTIS    # These values are examples that are unlikely
      '*'       DEFAULT)
  ...
  typeset -g POWERLEVEL9K_AWS_ASSERTIS_FOREGROUND=0
  typeset -g POWERLEVEL9K_AWS_ASSERTIS_BACKGROUND=2
  typeset -g POWERLEVEL9K_AWS_ASSERTIS_CONTENT_EXPANSION='AWS'

  typeset -g POWERLEVEL9K_AWS_ASSERTIS_ADMIN_BACKGROUND=160
  typeset -g POWERLEVEL9K_AWS_ASSERTIS_ADMIN_CONTENT_EXPANSION='AWS'
