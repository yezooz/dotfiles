# Generated by Powerlevel10k configuration wizard on 2022-01-15 at 11:06 GMT.
...
() {
  ...
  #
  # OPTIMIZED: Reduced from 21 to 8 segments for 50-100ms performance improvement
  # Removed redundant version managers and rarely-used segments
  # Full list commented below for easy re-enabling of specific segments
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # Uncomment any of these to re-enable:
    # direnv                  # direnv status (https://direnv.net/)
    # asdf                    # asdf version manager (https://github.com/asdf-vm/asdf)
    # pyenv                   # python environment (https://github.com/pyenv/pyenv)
    # goenv                   # go environment (https://github.com/syndbg/goenv)
    # nodenv                  # node.js version from nodenv (https://github.com/nodenv/nodenv) [REDUNDANT with nvm]
    # nodeenv                 # node.js environment (https://github.com/ekalinin/nodeenv) [REDUNDANT with nvm]
    # node_version          # node.js version [REDUNDANT with nvm]
